...
class SongHandler extends BaseAudioHandler with QueueHandler, SeekHandler {
  ...
  // BehaviorSubject to track shuffle mode state
  final BehaviorSubject<bool> _shuffleModeEnabled =
      BehaviorSubject.seeded(false);

  Stream<bool> get shuffleModeEnabled => _shuffleModeEnabled.stream;
  ...
  Future<void> toggleShuffleMode() async {
    final isShuffling = !_shuffleModeEnabled.value;
    _shuffleModeEnabled.add(isShuffling);
    await audioPlayer.setShuffleModeEnabled(isShuffling);
    if (isShuffling) {
